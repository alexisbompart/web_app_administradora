                    ...
                    <div>
                        ...
                        <select name="edificio_id" class="w-full rounded-lg border-slate_custom-200 text-sm focus:border-burgundy-800 focus:ring-burgundy-800">
                            ...
                            @foreach($edificios as $edif)
                                <option value="{{ $edif->id }}" {{ old('edificio_id', $afilapto->edificio_id ?? '') == $edif->id ? 'selected' : '' }}>
                        ...
                        <select name="apartamento_id" class="w-full rounded-lg border-slate_custom-200 text-sm focus:border-burgundy-800 focus:ring-burgundy-800">
                            ...
                            @if(isset($apartamentos))
                                @foreach($apartamentos as $apto)
                                    <option value="{{ $apto->id }}" {{ old('apartamento_id', $afilapto->apartamento_id ?? '') == $apto->id ? 'selected' : '' }}>
                                        {{ $apto->num_apto }}
                                    </option>
                                @endforeach
                            @endif
