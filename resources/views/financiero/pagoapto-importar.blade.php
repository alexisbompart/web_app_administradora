<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-slate_custom-400 mt-1">Carga incremental — agrega nuevos pagos por apartamento sin eliminar los existentes</p>
            </div>
    ...
    <div class="space-y-6">
        ...
        <form action="{{ route('financiero.pagoapto.importar.execute') }}" method="POST" onsubmit="return confirm('Se importaran {{ number_format($summary['validas']) }} registros. Los duplicados se omitiran. Continuar?')">
            @csrf
