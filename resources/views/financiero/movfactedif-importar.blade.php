<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <form action="{{ route('financiero.movfactedif.importar.execute') }}" method="POST" onsubmit="return confirm('Se importaran {{ number_format($summary['validas']) }} registros. Los duplicados se omitiran. Continuar?')">
            @csrf
