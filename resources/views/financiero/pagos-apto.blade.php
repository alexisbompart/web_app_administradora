    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-slate_custom-400 mt-1">cond_pago_aptos</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="{{ route('financiero.pagoapto.importar') }}" class="btn-primary">
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                ...
                <div class="w-10 h-10 bg-navy-800/10 rounded-lg flex items-center justify-center">
                    <i class="fas fa-credit-card text-navy-800"></i>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="text-sm font-heading font-semibold text-navy-800">
                <i class="fas fa-credit-card mr-2 text-burgundy-800"></i>Listado
            </h3>
        </div>
        <div class="card-body p-0">
                ...
                <table class="table-custom">
                    ...
                    <tbody>
                        ...
                        <tr>
                                ...
                                <td class="text-xs font-semibold">{{ number_format($item->monto_aplicado ?? 0, 2, ',', '.') }}</td>
                                <td class="text-xs">{{ $item->fecha_pag?->format('d/m/Y') }}</td>
            ...
            <div class="p-8 text-center">
                <div class="w-16 h-16 bg-slate_custom-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <i class="fas fa-credit-card text-2xl text-slate_custom-400"></i>
                </div>
